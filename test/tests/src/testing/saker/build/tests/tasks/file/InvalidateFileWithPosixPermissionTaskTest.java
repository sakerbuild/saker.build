...
@SakerTest
public class InvalidateFileWithPosixPermissionTaskTest extends CollectingMetricEnvironmentTestCase {
	...
	private static class InvalidatorTaskFactory implements TaskFactory<Object>, Task<Object>, Externalizable {
		...
		public Object run(TaskContext taskcontext) throws Exception {
			...
			taskcontext.getTaskUtilities().invalidateWithPosixFilePermissions(pk);

			SakerFile f = taskcontext.getTaskUtilities().createProviderPathFile(outputPath.getFileName() + "_f", pk);
