...
@SakerTest
public class SetTaskValueBuildTraceTest extends CollectingMetricEnvironmentTestCase {
	private static final SakerPath BUILD_TRACE_PATH = PATH_WORKING_DIRECTORY.resolve("build.trace");

	public static final class TaskValueTraceTaskFactory extends SelfStatelessTaskFactory<Object> {
	...
	protected void runTestImpl() throws Throwable {
		...
		runTask("main", new TaskValueTraceTaskFactory());
		if (project != null) {
			project.waitExecutionFinalization();
		}
		assertEquals(TraceTestUtils.getTraceField(tracepathkey, "tasks", 0, "values"),
